...
public:
	...
	void ConnectKeyPressed(std::function<std::remove_pointer<GLFWkeyfun>::type> callback);
...
private:
	...
	std::vector<std::function<std::remove_pointer<GLFWkeyfun>::type>> m_KeyPressedCallbacks;
